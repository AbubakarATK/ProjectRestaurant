...
<div class="container-lg" style="padding-top: 150px; text-align: center;">
  <h2 style="font-size: 45px;"><b>Privacy Policies</b></h2>
</div>
...
<div class="container-lg" style="padding-top: 30px;">
  ...
  <p>
      This Privacy Policy describes how coombesheadfarm.myshopify.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.
  </p>
  </br>
  <h2><b>Collecting Personal Information</b></h2>
  ...
  <ul>
    ...
    <li>name, billing address, shipping address, payment information (including credit card numbers), email address, and phone number.</li>
    <li>Source of collection: collected from you.</li>
    <li>Purpose of collection: to provide customer support.</li>
    <li>Source of collection: collected from you.</li>
    <li>Disclosure for a business purpose: shared with our customer service portal.</li>
  </ul>
  </br>
  <h2><b>Minors</b></h2>
  ...
  <h2><b>Sharing Personal Information</b></h2>
  ...
  <ul>
    <li>We use Google Analytics to help us understand how our customers use the Site. You can read more about how Google uses your Personal Information here: https://policies.google.com/privacy?hl=en.You can also opt-out of Google Analytics here:</li>
